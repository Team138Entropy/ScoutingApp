$(function () {
    const form2json = form => Array.from(form.querySelectorAll("input,select")).reduce((obj, elem) => {
      if(elem.getAttribute("data-type") === "bool") obj[elem.name] = elem.checked;
    ...
    function uploadAttachment(item){
      ...
      if (totalsize<=1000000){
        _.each(files_to_upload,function(file){
          ...
          console.log("totalsize <= 10000000");
